...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap" aria-expanded="true" aria-controls="collapseBootstrap" style="color: #333333 !important;">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('element/form'); ?>" style="color: #333333 !important;">
            <i class="fab fa-fw fa-wpforms"></i>
            <span>Forms</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTable" aria-expanded="true" aria-controls="collapseTable" style="color: #333333 !important;">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('element/uicolors'); ?>" style="color: #333333 !important;">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage" aria-expanded="true" aria-controls="collapsePage" style="color: #333333 !important;">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('element/charts'); ?>" style="color: #333333 !important;">
