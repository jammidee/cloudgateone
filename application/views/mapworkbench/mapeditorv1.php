      ...
      reader.onload = (event) => {
        ...
        const layer = L.geoJSON(geojson, {
          onEachFeature: function (feature, layer) {
            ...
            if (type === "polygon" && feature.properties && feature.properties.rectangle) {
              type = "rectangle"; // custom flag if you want
        ...
        pageMap.fitBounds(layer.getBounds());
        updateStatus();
      };
