                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="company_address" class="form-control" value="<?= $company_address; ?>"></td>
                        </tr>
                        <tr>
                            <th>Company Contact</th>
                            <td><input type="text" name="company_contact" class="form-control" value="<?= $company_contact; ?>"></td>
                        </tr>
                        <tr>
                            <th>Company Email</th>
                            <td><input type="email" name="company_email" class="form-control" value="<?= $company_email; ?>"></td>
                        </tr>
                        <tr>
