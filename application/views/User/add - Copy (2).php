                ...
                <div class="card-body">
                    <form class="form-horizontal form-label-left" role="form" enctype="multipart/form-data" method="post" action="<?= base_url(); ?>user/create" accept-charset="utf-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="password" type="text" placeholder="Set user connection password" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="advance" type="text" placeholder="Advance payment">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="amount" type="text" placeholder="Billing Amount">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="accpass" type="password" placeholder="Set login password">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="search_quota" value="100" type="number">
                            </div>
                        </div>
